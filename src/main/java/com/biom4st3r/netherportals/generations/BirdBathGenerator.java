...
public class BirdBathGenerator {
    public static Identifier birdBathFeature = new Identifier(NetherPortalMod.MODID,"birdbathpiece");
    ...
    public static void addPart(StructureManager sm, BlockPos blockpos, BlockRotation rotation,
        ...
        listPieces.add(new BirdBathGenerator.Piece(sm, birdBathFeature, blockpos, BlockRotation.NONE, 0));
        //EndCityGenerator
    }
    ...
    public static class Piece extends SimpleStructurePiece {
        ...
        {
            super(NetherPortalMod.birdBathPieceType,tag);
