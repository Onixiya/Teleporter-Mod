...
public class BirdBathRegister extends Screen {

    private TextFieldWidget nameField;
    private BlockPos location;

    protected BirdBathRegister(BlockPos blockPos) {
    ...
    public void doneAction()
    {
        ...
        .send(NetherPortalClientMod.createRegisterPortal(nameField.getText(), location));
        MinecraftClient.getInstance().getNetworkHandler().getClientConnection().send(NetherPortalClientMod.createRequestPortalList());
